                ...
                <div class="item">
                  <div class="products special-product">
                    ...
                    <div class="product">
                     ...
                     @endforeach <!-- /end foreach for product -->
                    <!-- /.item -->
                  </div>
                </div>
                <!-- /.item -->
              ...
              <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                ...
                <div class="item">
                  <div class="products special-product">
                    ...
                    @endforeach <!-- /.end for each special deals -->
                    <!-- /.product -->
                  </div>
                </div>
                <!-- /item -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
          ...
          <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
            ...
            <div class="tab-content outer-top-xs">
              ...
              <div class="tab-pane in active" id="all">
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                    ...
                    <!-- /.item -->
                    @endforeach <!-- end all option product for each -->
              ...
              @foreach ($categories as $category ) <!-- ei for each use korteci karon niche amader category table er id lagbe-->
              <div class="tab-pane" id="category{{ $category->id }}">
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">

                    @php
                        $catwiseProduct = App\Models\Product::where('category_id',$category->id)->orderBy('id','DESC')->get(); //<!--cat id product er cat id sthe match kore oi cat_id er product show korbe -->
                    @endphp
                    ...
                    @empty
                    <h4 class="text-danger">No Product Found</h4> <!-- empty hole ei product show korbe nahole uporer product show korbe -->

                    @endforelse <!-- end all option product for each -->
              ...
              <!-- /.tab-pane -->
              @endforeach <!-- end for each for cat -->
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">@if (session()->get('language') == 'hindi') {{ $skip_brand_2->brand_name_hin }} @else {{ $skip_brand_2->brand_name_en }} @endif</h3>
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
